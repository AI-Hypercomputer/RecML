...
class BinaryCrossEntropyOpsTest(parameterized.TestCase):
  ...
  def test_max_safe_block_v_scales_with_vmem(self):
    small = binary_cross_entropy_ops._max_safe_block_v(64 * _BYTES_IN_MB, 256)
    large = binary_cross_entropy_ops._max_safe_block_v(128 * _BYTES_IN_MB, 256)
    self.assertGreater(large, small)
  ...
  def test_max_safe_chunk_n_scales_with_vmem(self):
    small = binary_cross_entropy_ops._max_safe_chunk_n(
        64 * _BYTES_IN_MB, 128, 1024
    )
    large = binary_cross_entropy_ops._max_safe_chunk_n(
